...
[`returns-future-in-trait-with-supertrait.rs`]: ./examples/ok-returns-future-in-trait-with-supertrait.rs
[`afit-with-supertrait.rs`]: ./examples/ok-afit-with-supertrait.rs
[`dynosaur.rs`]: ./examples/ok-dynosaur.rs
